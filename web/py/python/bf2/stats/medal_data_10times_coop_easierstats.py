...
#This files has been changed for all awards needing 10 times less actual play time to get unlocked. Stats/Points/Requirements have been made more co-op friendly, also co-op in titanmaps is possible now (her titan/titanlite2 anyone?)
# criteria functions
...
medal_data = (	
		#Badges
			...
			('106_3', 'pcb', LIMIT_SINGLE, f_and( 	has_medal ('106_2'),
								f_plus(	global_stat ('wkls-5'),
									global_stat ('wkls-11'), 100),
								f_plus(	object_stat ('weapons', 'kills', WEAPON_TYPE_EU_PISTOL),
									object_stat ('weapons', 'kills', WEAPON_TYPE_PAC_PISTOL), 10)), 1000),
			...
			#Air Defense Badge, divided by 20, because sitting in airdefense sucks
			...
			#Titan Commander Badge, badge now works for Coo-op
			...
			#Medic Exellence Badge, time divided by 20, time for gold badge reduced to 2hours from 60
			...
			#Titan Combat Exellence Badge, times divided by 10, also co-op ready
			...
			#Titan Defense Exellence Badge, times divided by 10, also co-op ready
		...
		#Ribbons
			...
			#Titan Commander Ribbon, times divided by 10, co-op ready
		...
		#Medals
			...
			#Meritorius Titan Medal, times divided by 10, co-op ready
			...
			#Titan Medallion, times divided by 10, co-op ready, best player count set to 20 from 70
			('218',	'Tme',	LIMIT_SINGLE, f_and(	f_plus (	game_mode_time (1),
								global_stat ('tgpm-3'), 5400),
								game_mode_kills (3, 10),
								gpm_bestRound (3, 20)), 0),
